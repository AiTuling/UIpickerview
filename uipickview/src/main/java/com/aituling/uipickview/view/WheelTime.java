...
import com.aituling.uipickview.adpter.NumericWheelAdapter;
...
public class WheelTime {
    ...
    public WheelTime(View view) {
        super();
        this.view = view;
        type = WheelTimeType.ALL;
        setView(view);
    }

    public WheelTime(View view, WheelTimeType type) {
        super();
        this.view = view;
        this.type = type;
        setView(view);
