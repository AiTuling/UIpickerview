...
import com.aituling.uipickview.adpter.ArrayWheelAdapter;
...
public class WheelOptions<T> {
    ...
    private final int defautwheelTextViewSize = 16;
    private int wheelTextSize = defautwheelTextViewSize;
...
//		// 添加联动监听
     ...
     * 设置txt文本颜色
     *
     * @param outTextColor    未选中的颜色
     * @param centerTextColor 选中的颜色
     * @param lineColor       线条的颜色
     */
    public void setWheelTextColor(int outTextColor, int centerTextColor, int lineColor) {
        wv_option1.setWheelViewColor(outTextColor,centerTextColor,lineColor);
        wv_option2.setWheelViewColor(outTextColor, centerTextColor, lineColor);
        wv_option3.setWheelViewColor(outTextColor, centerTextColor, lineColor);
    }
